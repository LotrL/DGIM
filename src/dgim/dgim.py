...
from .dgim_module import LocalFeatureTransformer, FinePreprocess
...
class DGIM(nn.Module):
    def __init__(self, config):
        ...
        self.dgim_coarse = LocalFeatureTransformer(config)
    ...
    def forward(self, data):
        ...
        # 2. coarse-level dgim module
        mask_c0 = mask_c1 = None  # mask is useful in training
        if 'mask0' in data:
            mask_c0, mask_c1 = data['mask0'], data['mask1']
        feat_c0, feat_c1 = self.dgim_coarse(feat_c0, feat_c1, mask_c0, mask_c1)
